	...
	return (
		<DropdownMenu.Portal>
			<DropdownMenu.Content
				align="end"
				className="z-50 mt-2 w-64 overflow-hidden whitespace-normal rounded-xl border bg-white py-2 text-slate-700 shadow-lg dark:border-slate-700 dark:bg-slate-800 dark:text-white"
			>
				<CustomScrollArea>
