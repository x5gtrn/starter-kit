...
import { requestHashnode } from '../lib/api/request';
...
export const getStaticProps: GetStaticProps<Props, Params> = async ({ params }) => {
	...
	const [postData, morePostsData] = await Promise.all([
		requestHashnode(SinglePostByPublicationDocument, { host, slug }),
		requestHashnode(MorePostsByPublicationDocument, { first: 4, host }),
	]);
	...
	const pageData = await requestHashnode(PageByPublicationDocument, { host, slug });
...
export const getStaticPaths: GetStaticPaths = async () => {
	const data = await requestHashnode(SlugPostsByPublicationDocument, {
		first: 10,
